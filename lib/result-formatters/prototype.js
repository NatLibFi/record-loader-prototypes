...
function factory() {
	...
	return {
	    merge: function(result, results_level)
	    {
		return result;
	    },
	    match: function(result, results_level)
	    {
		return result;
	    },
	    load: function(result, results_level)
	    {
		return result;
	    },
	    additional: function(result, step, results_level)
	    {
		return result;
	    },
	    ...
	    data: function(record, results_level, type)
	    {
		return record;
	    }
	};
